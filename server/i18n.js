...
const STRINGS = {
  ru: {
    ...
    dateInvalid: 'Проверьте имя и дату',
    dateNotFound: 'Дата не найдена',
    dateLimitReached: 'Достигнут лимит в 20 дат. Удалите одну из старых, чтобы добавить новую.',
    gardenLimitReached: 'В вашем саду уже 60 открыток — уберите одну из старых, чтобы сохранить новую.',
  ...
  en: {
    ...
    dateInvalid: 'Check the name and date',
    dateNotFound: 'Date not found',
    dateLimitReached: 'You\'ve reached the 20-date limit. Delete an old one to add a new one.',
    gardenLimitReached: 'Your garden already has 60 cards — remove an old one to save a new one.',
