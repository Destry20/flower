...
const OCCASIONS = [
  ...
  {id:'love', label:{ru:'Любовь',en:'Love'}, color:'#4B2E3D', stamp:{ru:'С любовью',en:'With love'}, placeholder:{ru:'Ты — моё самое доброе утро и первая мысль, которая приходит раньше, чем я просыпаюсь...',en:'You are my favorite good morning...'}, anim:'hearts'},
